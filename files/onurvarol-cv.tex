...
{\footnotesize \href{https://scholar.google.com/citations?user=t8YAefAAAAAJ}{Google Scholar} \\ citations: 4,520 \\h-index: 20 \\ i10-index: 24}}
...
\textbf{Invited Talks}
\begin{innerlist}
\item Modeling individual and group behavior in complex interactive systems, The University of Edinburgh, Scotland (Teleconference, 2020/03/30)
\item Modeling individual and group behavior in complex interactive systems, Aalto University, Finland (Teleconference, 2020/03/16)
...
\begin{innerlist}
\item Zararl? Sosyal Medya Kampanyalar?, Twitter Botlar? ve Sosyal Riskleri Önleme Algoritmalar? \\ \url{breaker.audio/veri-tezgahi/e/76727081 } (2020-10-23)
