...
{\footnotesize \href{https://scholar.google.com/citations?user=t8YAefAAAAAJ}{Google Scholar} \\ citations: 2,140 \\h-index: 15 \\ i10-index: 16}}
...
\begin{innerlist}
\item[U.5] \textbf{O. Varol}, I. Uluturk \textbf{``Journalists on Twitter: Self-branding, Audiences, and Involvement of Bots''}
\item[U.4] X. Wang, \textbf{O. Varol}, T. Eliassi-Rad \textbf{``L2P: Learning to Place for Estimating Heavy-Tailed Outcomes''}, ArXiv:1908.04628
\item[U.3] X. Wang, B. Yucesoy. \textbf{O. Varol}, T. Eliassi-Rad, AL. Barabási \textbf{``Success in Books: Predicting Book Sales Before Publication''}
