...
{\footnotesize \href{https://scholar.google.com/citations?user=t8YAefAAAAAJ}{Google Scholar} \\ citations: 6,530 \\h-index: 22 \\ i10-index: 28}}
...
\item[U.3] X. Wang, \textbf{O. Varol}, T. Eliassi-Rad \textbf{``Information Access Equality on Network Generative Models''}, ArXiv:2107.02263

\item[U.2] Singh, K., Lima, G., Cha, M., Cha, C., Kulshrestha, J., Ahn, Y. Y., \textbf{Varol, O}. (2021). \textbf{``Misinformation, Believability, and Vaccine Acceptance Over 40 Countries: Takeaways From the Initial Phase of The COVID-19 Infodemic''} arXiv preprint arXiv:2104.10864.
...
Istanbul, Turkey
\begin{innerlist}
\item[] Network Science (Lecturer, Spring 2021)
\end{innerlist}
\end{innerlist}
