...
\begin{table}
	\begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}lr}
		...
		\normalsize{ \href{http://www.soic.indiana.edu/}{School of Informatics and Computing} \href{http://www.iu.edu/}{Indiana University}}\\
		
		\normalsize{\href{mailto:ovarol@indiana.edu}{ovarol@indiana.edu}} & \normalsize{919 E. 10th St, Bloomington IN, 47408, USA}\\
	\end{tabular*}
\end{table}
\end{center}
\vspace{-10mm}
...
\item[] Ph.D.,
        \href{http://www.soic.indiana.edu/}
             {Complex Systems track of the Ph.D. in Informatics} and
             minor in Statistics (expected graduation date: June 2017) \\
...
\item[] M.Sc.,
	...
	Advisors:
              \href{http://denizyuret.blogspot.com/}{Deniz Yüret}, 
...
\item[J.6] C. Ogan, \textbf{O. Varol} \textbf{``Combining Content Analysis with Network Analysis in the Study of a Social Movement: Twitter Use During Gezi Park Protests"}, Information, Communication and Society 1-19, 2016

\item[J.5] E Ferrara, \textbf{O Varol}, C Davis, F Menczer, A Flammini \textbf{``The Rise of Social Bots"}, Communications of the ACM 59(7):96-104, 2016

\item[J.4] Davis CA, Ciampaglia GL, Aiello LM, Chung K, Conover MD, Ferrara E, Flammini A, Fox GC, Gao X, Gonçalves B, Grabowicz PA, Hong K, Hui P, McCaulay S, McKelvey K, Meiss MR, Patil S, Peli Kankanamalage C, Pentchev V, Qiu J, Ratkiewicz J, Rudnick A, Serrette B, Shiralkar P, \textbf{Varol O}, Weng L, Wu T, Younge AJ, Menczer F. \textbf{``OSoMe: The IUNI observatory on social media"}, PeerJ Computer Science 

\item[J.3] V.S. Subrahmanian, A. Azaria, S. Durst, V. Kagan, A. Galstyan, K. Lerman, L. Zhu, E. Ferrara, A. Flammini, F. Menczer, R. Waltzman, A. Stevens, A. Dekhtyar, S. Gao, T. Hogg, F. Kooti, Y. Liu, \textbf{O. Varol}, P. Shiralkar, V. Vydiswaran, Q. Mei, T. Huang. \textbf{``The DARPA Twitter Bot Challenge"}, IEEE Computer 49(6), 2016

\item[J.2] M JafariAsbagh, E Ferrara, \textbf{O Varol}, F Menczer, A Flammini \textbf{``Clustering memes in social media streams"}, Social Network Analysis and Mining 4(237):1-13, 2014

\item[J.1] \textbf{O. Varol}, D. Yuret, B. Erman, A. Kabak\c{c}{\i}oglu \textbf{``Mode coupling points to functionally important residues in Myosin II"}, PROTEINS: Structure, Function, and Bioinformatics 
...
\item[C.5] \textbf{O Varol}, E Ferrara, C Ogan, F Menczer, and A Flammini. \textbf{``Evolution of online user behavior during a social upheaval"}. ACM Web Science Conference 2014 (\textbf{Best paper award}) %(Full paper, acceptance rate 14\%) 
...
\textbf{Research}
\begin{outerlist}
\item[] \textbf{DOISAC}: Project name stands for ``Detecting Orchestrated Information and Synthetic Account Campaigns". This project founded by the Office of Naval Research aims at detecting orchestrated information and synthetic activity campaigns on social media using machine learning and computational tools. 
...
\begin{innerlist}        
        \item[] PIs:
              ...
              \href{https://sites.google.com/site/aflammin/}
                   {Assoc. Prof. Alessandro Flammini},        
\end{innerlist}

\item[] \href{http://cnets.indiana.edu/groups/nan/despic}
			 {\textbf{DESPIC}}: Project name stands for ``Detecting Early Signature of Persuasion in Information Cascades" and aims to design a system detect persuasion campaigns at their early stage of inception, in the context of online social media. This project founded by DARPA SMISC program.
\begin{innerlist}        
        \item[] PIs:
              \href{https://sites.google.com/site/aflammin/}
                   {Assoc. Prof. Alessandro Flammini}, 
...
\item[] \href{http://cnets.indiana.edu/groups/nan/truthy}
			 {\textbf{Truthy}}: This project aims to understand how information propagates through complex socio-technical information networks. In this project, I analyzed and studied roles of individuals during social upheavals, diffusion of trending topics in spatio-temporal space. I also worked on classification of social bots.
...
\begin{innerlist}        
        \item[] Advisors:
              ...
              \href{http://home.ku.edu.tr/~akabakcioglu/}
              	   {Assist. Prof. Alkan Kabak\c{c}{\i}oglu}        
        \end{innerlist}
...
Electrical Engineering Society (EMO) Project Competition 1st Rank (2010)\\
...
\textbf{Conference PC member}: NetSci'17, WWW'17, ICWSM'17\\
\textbf{Conference subreviewer}: ICWSM'15, IC2S2'15, ASONAM'15, WebScience'14\\
\textbf{Journal reviews}: PLoS One, Network Science
