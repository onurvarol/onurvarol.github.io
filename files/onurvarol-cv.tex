...
{\footnotesize \href{https://scholar.google.com/citations?user=t8YAefAAAAAJ}{Google Scholar} \\ citations: 2,218 \\h-index: 16 \\ i10-index: 16}}
\textbf{Journal Articles}
\begin{innerlist}

\item[J.13] \textbf{O. Varol}, I. Uluturk \textbf{``Journalists on Twitter: Self-branding, Audiences, and Involvement of Bots''} (Accepted to \textit{Journal of Computational Social Science})
