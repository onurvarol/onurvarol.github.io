...
\begin{table}
	\begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}lr}
		...
		\normalsize{Sabanci University, Istanbul Turkiye}\\
	\end{tabular*}
\end{table}
\end{center}
\vspace{-10mm}
...
{\footnotesize \href{https://scholar.google.com/citations?user=t8YAefAAAAAJ}{Google Scholar} \\ citations: 10,600 \\h-index: 28 \\ i10-index: 33}}
\textbf{Journal Articles}
\begin{innerlist}

\item[J.24] O. C. Seckin, A. Atalay, E. Otenen, U. Duygu, \textbf{O. Varol} \textbf{``Mechanisms Driving Online Vaccine Debate During the COVID-19 Pandemic''}, Social Media + Society, 10(1)., 2024

\item[J.23] \textbf{O. Varol} \textbf{``Should we agree to disagree about Twitter's bot problem?''}, Online Social Networks and Media, 37 (2023): 100263.
...
\textbf{Editorial boards}: EPJ-DS (2023-); PloS One (2022-); Area Editor for Online Social Networks and Media (2021-); Technical committee member for Online Social Networks and Media (2017-2020); Editorial board member of Human Behavior \& Emerging Technologies (HBET); \\
