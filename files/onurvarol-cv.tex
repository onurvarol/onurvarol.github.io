...
\begin{table}
	\begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}lr}
		...
		\normalsize{\href{mailto:onur@varollab.com}{onur@varollab.com}} & \normalsize{177 Huntington Ave. 11th floor Boston, MA 02115}\\
	\end{tabular*}
\end{table}
\end{center}
\vspace{-10mm}
...
{\footnotesize \href{https://scholar.google.com/citations?user=t8YAefAAAAAJ}{Google Scholar} \\ citations: 3,315 \\h-index: 16 \\ i10-index: 17}}
\textbf{Journal Articles}
\begin{innerlist}

\item[J.14] Fragile Families Challenge Team \textbf{``Measuring the predictability of life outcomes with a scientific mass collaboration''} \textit{Proceedings of the National Academy of Sciences}, 2020

\item[J.13] \textbf{O. Varol}, I. Uluturk \textbf{``Journalists on Twitter: Self-branding, Audiences, and Involvement of Bots''} \textit{Journal of Computational Social Science}, 2019

\item[J.12] X. Wang, B. Yucesoy, \textbf{O. Varol}, T. Eliassi-Rad, AL. Barabási \textbf{``Success in Books: Predicting Book Sales Before Publication''} (Accepted to \textit{EPJ Data Science})
...
\item[C.14] Yang K., \textbf{Varol O.}, Hui P., Menczer F. \textbf{``Scalable and Generalizable Social Bot Detection through Data Selection''}, ArXiv:1911.09179 (Accepted AAAI'20)
...
\begin{innerlist}
\item[U.4] Gysi D., Do Valle I., Zitnik M., Ameli A., Gan X., \textbf{Varol O.}, Sanchez H., Baron R., Ghiassian D., Loscalzo J., Barabasi AL. \textbf{``Network Medicine Framework for Identifying Drug Repurposing Opportunities for COVID-19''}
\item[U.3] M. Sayyadiharikandeh, \textbf{O. Varol}, K. Yang, A. Flammini, F. Menczer \textbf{``Detection of Novel Social Bots by Ensembles of Specialized Classifiers''}
\item[U.2] X. Wang, \textbf{O. Varol}, T. Eliassi-Rad \textbf{``L2P: Learning to Place for Estimating Heavy-Tailed Outcomes''}, ArXiv:1908.04628
...
Bloomington IN, USA
\begin{innerlist}
\item[] Mohsen Sayyadi (Computer Science PhD student, [Spring 2018,---])
...
\textbf{Organized Workshops}
\begin{innerlist}
\item \href{http://www.onurvarol.com/hlf-workshop/}{Workshop on \textit{Misinformation and Social Bots} at the 7th Heidelberg Laureate Forum} (09/23/2019)
\end{innerlist}
...
\textbf{Editorial boards}: Technical committee member for Online Social Networks and Media (OSNEM); Editorial board member of Human Behavior \& Emerging Technologies (HBET); Guest editor for Applied Network Science Special Issue on Epidemics, Dynamics \& Control on  Networks \\
\textbf{Conference organizing committee}: IC2S2'20 Publication Chair\\
\textbf{Satellite co-organizer}: Quantifying Success (NetSci'20)\\
\textbf{Workshop co-organizer}: Open Science for an Open Society (CCS'16)\\
...
\textbf{Conference PC member}: WWW'17-'20; WSDM'19/'20; ICWSM'17-'20; KDD'19; SDM'19; WebSci'18/'19/'20; CHI'18; CSCW'18/'19; CompleNet'18; NetSci'17-'20; NetSciX'20; SocInfo'17-'20; IC2S2'17-'20; ICCS'20; HyperText'17/'18/'19; DSAA'17/'18/'19\\
