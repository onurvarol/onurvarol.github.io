...
{\footnotesize \href{https://scholar.google.com/citations?user=t8YAefAAAAAJ}{Google Scholar} \\ citations: 2,120 \\h-index: 15 \\ i10-index: 16}}
...
\begin{innerlist}
\item[U.4] \textbf{O. Varol}, I. Uluturk \textbf{``Journalists on Twitter: Self-branding, Audiences, and Involvement of Bots''}
\item[U.3] Hui, P.K.,Yang, K.C., \textbf{Varol O.}, Menczer F.  \textbf{``Election Impersonators: Abusing the Right to Be Forgotten''}
...
\item[U.1] X. Wang, B. Yucesoy. \textbf{O. Varol}, T. Eliassi-Rad, AL. Barabási \textbf{``Success in Books: Predicting Book Sales Before Publication''}
\end{innerlist}
