...
\begin{table}
	\begin{tabular*}{\linewidth}{@{\extracolsep{\fill}}lr}
		...
		%\normalsize{\href{mailto:onur.varol@sabanciuniv.edu}{onur.varol@sabanciuniv.edu}} &
		\normalsize{\href{http://www.onurvarol.com}{onurvarol.com} $\cdot$ \href{http://www.varollab.com}{varollab.com}} & 
...
\textbf{Research Project Grants}
\begin{innerlist}
\item TUBITAK 2247-D, ``Developing systems for coordination and automated behavior detection on online social networks'' (2022-2025)
\item Sabanci University President's Office Fund, ``Observatory of Online Conversations and Belief Modeling'' (2022-2025)
\item TUBITAK 1002, ``Causal analysis of daylight saving time and quantifying its impact on wellbeing'' (2021-2022)
\item Sabanci University Integration Grant, ``Collecting Social Media Data Streams and Experimentation of Online Networks'' (2021-2023)
\end{innerlist}



\section{Honors and Awards}
The Turkish Science Academy \textbf{BAGEP} Young Scientist Awards (2022)\\
...
{\footnotesize \href{https://scholar.google.com/citations?user=t8YAefAAAAAJ}{Google Scholar} \\ citations: 6,815 \\h-index: 23 \\ i10-index: 29}}
\textbf{Journal Articles}
\begin{innerlist}

\item[J.18] Singh, K., Lima, G., Cha, M., Cha, C., Kulshrestha, J., Ahn, Y. Y., \textbf{Varol, O}. (2021). \textbf{``Misinformation, Believability, and Vaccine Acceptance Over 40 Countries: Takeaways From the Initial Phase of The COVID-19 Infodemic''} Plos One, 17(2), e0263381, 2022

\item[J.17] Gysi D., Do Valle I., Zitnik M., Ameli A., Gan X., \textbf{Varol O.}, Sanchez H., Baron R., Ghiassian D., Loscalzo J., Barabasi AL. \textbf{``Network Medicine Framework for Identifying Drug Repurposing Opportunities for COVID-19''} \textit{Proceedings of the National Academy of Sciences}, 118 (19) e2025581118, 2021
...
\item[U.3] O.C. Seckin, \textbf{O. Varol} \textbf{``Academic Support Network Reflects Doctoral Experience and Productivity''}, ArXiv:2203.03430

\item[U.2] X. Wang, \textbf{O. Varol}, T. Eliassi-Rad \textbf{``Information Access Equality on Network Generative Models''}, ArXiv:2107.02263
...
Istanbul, Turkey
\begin{innerlist}
\item[] Machine Learning (Lecturer, Spring 2022)
\item[] Network Science (Lecturer, Spring 2021 and Spring 2022)
\end{innerlist}
\end{innerlist}
...
\item[] Davut Bayik (Data Science MSc student, [Spring 2021, -- ])
\item[] Umut Duygu (Political Science MA student, [Spring 2021, -- ])
\item[] Furkan Okuyucu (Data Science MSc student, [Spring 2021, -- ])
\item[] Mert Ozturk (Data Science MSc student, [Spring 2021, -- ])
\item[] Mutlu Soruklu (Data Science MSc student, [Spring 2021, -- ])
\item[] Ozgur Can Seckin (Data Science MSc student, [Spring 2021, -- ])
\item[] Baris Temel (Data Science MSc student, [Spring 2021, -- ])
\item[] Ozgun Yargi (Data Science MSc student, [Spring 2021, -- ])
\end{innerlist}
\end{innerlist}
...
\textbf{Editorial boards}: Area Editor for Online Social Networks and Media (2021-); Technical committee member for Online Social Networks and Media (2017-2020); Editorial board member of Human Behavior \& Emerging Technologies (HBET); \\
...
\textbf{Satellite/Workshop co-organizer}: Quantifying Success (Networks'20); Quantifying Success (NetSci'20); Open Science for an Open Society (CCS'16)\\
...
\textbf{Conference Senior PC member}: HyperText'18; ICWSM'20/'21 \\
\textbf{Conference PC member}: WEB'17-'21; WSDM'19/'20/'21; ICWSM'17-'20; KDD'19; SDM'19; AAAI'21; WebSci'18/'19/'20; CHI'18; CSCW'18/'19; CompleNet'18; NetSci'17-'20; NetSciX'20; SocInfo'17-'20; IC2S2'17-'21; ICCS'20; HyperText'17/'18/'19; DSAA'17/'18/'19\\
